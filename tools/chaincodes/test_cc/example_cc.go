...
func (t *SimpleChaincode) saveUser(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	if len(args) != 3 { // The number of input parameter should be 22
		return shim.Error("Incorrect number of arguments. Expecting 22, function followed by 22 names")
	}
