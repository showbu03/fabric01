...
2. golang 설치
   ...
   * wget [https://storage.googleapis.com/golang/go1.11.2.linux-amd64.tar.gz](https://storage.googleapis.com/golang/go1.11.2.linux-amd64.tar.gz)
...
6. Hyperledger Fabric 다운로드\(필요시\)
   * git clone -b release-1.3 [https://github.com/hyperledger/fabric](https://github.com/hyperledger/fabric)
   * cd fabric
   * make docker 
   * 만약, git clone 인증서 관련 오류시 gotools.mk 파일 수정 // gotools-install 마지막 라인에 export GIT\_SSL\_NO\_VERIFY=1 추가 후 make clean -&gt; make docker
...
상기디렉토리의 balance\_cc 를 바라본다.

다른 체인코드를 install & instantiate 하기 위해서는 example\_cc 디렉토리를 생성하고 id를 example 로 주면 된다
...
[http://localhost:3500/api-explorer/](http://localhost:3500/api-explorer/)
...
[https://github.com/hyperledger/fabric/tree/release-1.2/examples/events/block-listener](https://github.com/hyperledger/fabric/tree/release-1.2/examples/events/block-listener)
...
[https://sabzil.org/govendor/](https://sabzil.org/govendor/)
